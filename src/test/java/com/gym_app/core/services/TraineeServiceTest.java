...
public class TraineeServiceTest {
    ...
    public void testCreateTrainees() {
        ...
        Trainee additionalTrainee = new Trainee("Tony", "Stark", "tony.stark", "ironman", true, LocalDate.now().minusYears(50), "RIP");
    ...
    public void testUpdateTrainee() {
        long idSample = trainees[2].getUserId();
    ...
    public void testDeleteTrainee() {
        long idSample = trainees[3].getUserId();
    ...
    public void testSelectTrainee() {
        long idSample = trainees[4].getUserId();
        Optional<Trainee> selectedTrainee = traineeService.select(idSample);

        assertTrue(selectedTrainee.isPresent(), "Trainee with ID " + idSample + " should be present");

        assertThrows(NoSuchElementException.class, () -> traineeService.select(999L),
